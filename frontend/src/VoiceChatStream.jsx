...
export default function VoiceChatStream() {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-gradient-to-b from-black/60 via-black/30 to-emerald-900/50 -z-10" />
      ...
      <p className="text-stone-900 text-center mb-8 font-bold text-lg max-w-2xl drop-shadow-[0_1px_4px_rgba(0,0,0,0.6)]">
      ...
      <div className="mb-8 flex flex-col items-center relative">
        ...
        />
        <div className="relative z-10 mt-20 text-lg font-bold text-stone-900">
